// YesNoOracleWheel.js — Yes No Oracle Wheel implementation
...
const ORACLE_SEED_ENTRIES = [
  { text: 'Yes', size: 1 },
  { text: 'No', size: 1 },
  { text: 'Maybe', size: 1 },
  { text: 'Ask Again', size: 1 },
  { text: 'Definitely', size: 1 },
...
export function renderYesNoOracleWheel(container) {
  ...
  // Custom parsing in UI, but defaulting to seed
  const defaultEntries = ORACLE_SEED_ENTRIES.map(e => e.text);
