...
const routes = {
  ...
  'letter-picker-wheel': () => import(`./wheels/LetterPickerWheel.js?v=${ASSET_VERSION}`).then((m) => m.renderLetterPickerWheel),
  ...
  'chance-fortune-wheel': () => import(`./wheels/ChanceFortuneWheel.js?v=${ASSET_VERSION}`).then((m) => m.renderChanceFortuneWheel),
  'oracle': () => import(`./wheels/YesNoOracleWheel.js?v=${ASSET_VERSION}`).then((m) => m.renderYesNoOracleWheel),
  'tarot': () => import(`./wheels/YesNoTarot.js?v=${ASSET_VERSION}`).then((m) => m.renderYesNoTarot),
...
const routeTitles = {
  ...
  'rainbow': 'Rainbow Wheel — Free Colorful Spinning Wheel Online',
  'wheel-of-fate': 'Wheel of Fate — Destiny Spinner With Weighted Outcomes',
  'word': 'Word Wheel — Free Random Word Picker Spinner',
  'letter-picker-wheel': 'Letter Picker Wheel — Free Random Letter Spinner Online',
  'spin-the-wheel-truth-or-dare': 'Truth or Dare Wheel — Free Party Game Spinner',
  'dti-theme': 'DTI Theme Wheel — Random Dress To Impress Theme Generator',
...
const routeDescriptions = {
  ...
  'rainbow': 'Spin the Rainbow Wheel for a colorful random result. Each segment gets a distinct hue from the spectrum. Free, no signup.',
  'wheel-of-fate': 'Spin the Wheel of Fate to let destiny decide. Weighted outcomes let you control probability. Free, no signup.',
  'word': 'Spin the Word Wheel to randomly pick from your custom word list. Upload CSV or paste words. Free, no signup.',
  ...
  'spin-the-wheel-truth-or-dare': 'Spin the Truth or Dare wheel for parties. 200+ prompts, player picker, neon theme. Free, no signup.',
  'dti-theme': 'Spin the DTI Theme Wheel for random Dress To Impress outfit themes. 180+ themes by category. Free, no signup.',
...
function updateStaticUi(uiText) {
  const mappings = {
    ...
    navTarotOracleLabel: uiText.tarotAndOracleHeading || 'Tarot & Oracle',
    ...
    navLetterPickerWheelLabel: getLocalizedRouteContent(currentLocale, 'letter-picker-wheel').title,
    ...
    navChanceFortuneWheelLabel: getLocalizedRouteContent(currentLocale, 'chance-fortune-wheel').title,
    navYesNoTarotLabel: getLocalizedRouteContent(currentLocale, 'tarot').title,
    navYesNoOracleLabel: getLocalizedRouteContent(currentLocale, 'oracle').title,
